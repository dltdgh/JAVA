...
if(!storageid.equals("")){
	sql = sql+" and storageid="+storageid;
}
if(!passman.equals("")){
	sql = sql+" and passman='"+passman+"'";
}
sql += ";";
...
<body>
	<div style="width:600px; height:auto; margin-left:auto; margin-right:auto; margin-top:20px;">
    	...
    	<div style="width:600px; float:left;">
        	<p style="text-align:right">欢迎<span style="margin-left:5px;margin-right:5px; color:red;"><%= tUser.getName() %></span><a href="doLogout.jsp">登出</a></p>
        </div>
        <div style="width:600px; float:left;">
